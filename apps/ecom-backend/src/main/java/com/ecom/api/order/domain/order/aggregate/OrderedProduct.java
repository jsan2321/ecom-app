...
import com.ecom.api.order.domain.order.vo.OrderPrice;
import com.ecom.api.order.domain.order.vo.OrderQuantity;
import com.ecom.api.order.domain.order.vo.ProductPublicId;
import com.ecom.api.product.domain.aggregate.Product;
import com.ecom.api.product.domain.vo.ProductName;
