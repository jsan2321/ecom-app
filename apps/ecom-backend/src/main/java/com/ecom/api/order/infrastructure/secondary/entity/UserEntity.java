package com.ecom.api.order.infrastructure.secondary.entity;

import com.ecom.api.order.domain.user.aggregate.User;
import com.ecom.api.order.domain.user.aggregate.UserBuilder;
import com.ecom.api.order.domain.user.vo.*;
import com.ecom.api.shared.jpa.AbstractAuditingEntity;
